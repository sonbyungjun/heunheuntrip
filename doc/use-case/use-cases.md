# 흔흔여행 (HeunheunTrip) - 흔하지만 흔하지않은 여행
숙박 예약 및 여행 블로그

# 유스케이스 목록

## Actors
![검색창](../use-case/diagram/actors로변경바람.jpeg)
...
## Use-Cases
![검색창](../use-case/diagram/usecases.jpg)
...
### [블로그 리스트 보기](./minhee/블로그리스트.md)(회원, 비회원)
- 회원, 비회원이 블로그 리스트를 보는 것.

### [블로그 상세 보기](./minhee/블로그상세.md)(회원, 비회원)
- 회원, 비회원이 블로그 리스트에서 글을 선택하여 상세하게 보는 것

### [고객센터 QnA 보기](./minhee/고객센터Q&A리스트.md)(비회원, 회원)
...
### [숙소 문의 답변하기](./minhee/숙소문의답변.md)(일반회원, 호스트)
- 일반회원과 호스트가 메세지로 문의하거나 답변하는 것

### [고객센터 문의사항 작성하기](./minhee/고객센터문의사항작성.md)(일반회원)
- 일반회원이 고객센터 문의사항을 작상하는 것.

### [고객센터 문의사항 조회하기](./minhee/고객센터문의사항리스트.md)(일반회원, 관리자)
- 일반회원이 작성한 문의사항을 조회하는 것

### [고객센터 문의사항 답변하기](./minhee/고객센터문의사항답변.md)(관리자)
- 일반회원이 작성한 문의사항을 관리자가 답변하는 것.

### [리뷰 등록, 변경하기](./byungjun/uc004-reviewManagement.md)(일반회원)
- 일반회원이 다녀온 숙소에 대해 리뷰를 등록하고 변경하는 것.

### [블로그 등록 변경하기](./minhee/블로그등록변경.md)(일반회원)
- 일반회원이 블로그를 작성하고 변경하는 것

### [블로그 삭제하기](./minhee/블로그삭제.md)(일반회원, 관리자)
- 일반회원이 작성한 블로그를 삭제하는 것.

### [마이페이지에서 블로그 조회, 상세보기](./minhee/내블로그게시글리스트상세.md)(일반회원)
- 일반회원이 마이페이지에서 자신이 쓴 블로그 게시글을 조회하거나 상세보기 하는 것
